 ...
 * `../<domain>/tool-registrations` lines. Pointing only identity somewhere else would make the one
 ...
 */
export { buildIdentityRegistrations, identityDerivedRisk, type IdentityToolDeps } from "@jini-ai/cms/identity";
