 ...
 *  connection's own `connectTimeoutMs` — the same bound `bootstrap.ts`'s `defaultConnect` applies
 *  to the identical transport for the identical reason (the handshake IS the connect).
