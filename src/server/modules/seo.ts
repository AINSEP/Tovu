 ...
 *
 * Owns all 10 registrations: 8 admin routes (`get-entry`/`put-entry`/`get-entry-analyze`/
 ...
 * in `app.ts` sits at the exact same position the 10 SEO registrations previously occupied — well
