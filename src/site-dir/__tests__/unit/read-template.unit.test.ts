...
import { seededWorkspace, seededPosts, seededPresentation } from "../../../server/seed";
 ...
 * `src/site-dir/read-template.ts` + the `templates/starter/*.json` data files (tasks.md T008/T009).
 * Correct TDD state.
 *
 ...
 * names (8 posts, `activeThemeId: "tovu-official"`). REQ-02's binding rule is content-equality
