...
import { DEFAULT_GC_GRACE_MS, runBlobGcDeletePass, runBlobGcUnlinkPass } from "../blob-gc";

const WORKSPACE_ID = "workspace-1";

/**
 * Shared deps builder (ADR-027 §5 GC tests need a fast-forwardable clock —
 * same `setNow` closure pattern as `src/identity/__tests__/auth-service.test.ts`'s
