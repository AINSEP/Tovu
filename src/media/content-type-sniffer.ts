 ...
 * consuming route is `server/routes/admin/media/original.ts`.
 *
 ...
 * (the route layer forces `Content-Disposition: attachment` for the former). This
 ...
 * a separate `application/xhtml+xml` value (the route layer still blocks that literal string too, as
