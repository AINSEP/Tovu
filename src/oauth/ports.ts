 ...
 *
 * `src/connectors/` already runs a working, hardened per-workspace "click to authorize" flow, and
 ...
 *  but is restated so `src/oauth/` depends on no repository beyond its own types. */
