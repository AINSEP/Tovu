...
| spec_root | ADS-memory/specs/013-members |
...
|---|---|---|
| `ADR-030-members.md` (`ADS-memory/reports/architecture/`) | codebase-analysis | The governing decision this spec verifies against real code, clause by clause |
