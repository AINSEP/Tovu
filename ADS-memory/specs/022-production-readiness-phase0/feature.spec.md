...
- [x] spec_id assigned and unique (verified against `ADS-memory/specs/` and `ADS-memory/reports/pipeline/` — 001-015, 021 in use; 016-020 reserved by the gated-mutations workstream; 022 is next free)
