...
Note: `ADS-memory/governance/constitution.md` is still not bootstrapped for this project (unchanged since SPEC-001); the toolkit default articles are applied. Flagged to Coordinator for post-spec bootstrap.
...
- [x] spec_id assigned and unique (SPEC-002; verified against `ADS-memory/specs/`)
