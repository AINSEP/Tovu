...
| spec_root | ADS-memory/specs/004-declarative-theme-system/ |
...
|---|---|---|
| `ADS-memory/reports/architecture/ADR-010-declarative-themes-by-default.md` | codebase-analysis | The governing decision this spec implements (declarative default, no-code rule, validation posture, component-by-reference) |
| `ADS-memory/reports/architecture/ADR-002-blessed-rendering-target.md` | codebase-analysis | Renderer-agnostic contracts; React as eventual implementation — contract here must not assume the string renderer |
