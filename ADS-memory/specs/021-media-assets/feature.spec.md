...
- [x] spec_id assigned and unique (SPEC-021 — scanned `ADS-memory/reports/pipeline/` [001-015] and the reserved-but-unused SPEC-016..020 range per dispatch instruction; started numbering at 021)
