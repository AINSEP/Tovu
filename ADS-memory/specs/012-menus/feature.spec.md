...
`ADS-memory/specs/012-menus/` that lets any agent or human answer "what does
...
- [x] spec_id assigned and unique (verified against existing `ADS-memory/reports/pipeline/` folders — `012-menus` was not previously used; `010`/`011` do not exist yet, `012` was the fixed identifier given for this task)
