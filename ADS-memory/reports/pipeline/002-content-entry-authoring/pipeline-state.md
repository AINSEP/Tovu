...
| provider_output_root | ADS-memory/specs/002-content-entry-authoring/ |
| spec_entrypoint_path | ADS-memory/specs/002-content-entry-authoring/feature.spec.md |
| spec_readiness_artifact | ADS-memory/specs/002-content-entry-authoring/spec-dod.md |
| spec_version | 1.0.0 |
...
`ADS-memory/governance/constitution.md` not bootstrapped — toolkit-default articles + Art. VI no-auth exception apply. RT-007 flags an Article I (Library-First) pre-flight for the Architect (slug derivation).
