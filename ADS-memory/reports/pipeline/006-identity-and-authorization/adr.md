# ADR-PIPE-006: API-Key Issuance & CREATE_PRINCIPAL Plumbing — Closing the SPEC-006 REQ-08 Gap
...
- Relates: ADR-006 (rule-of-two), ADR-007 (workspace scoping), ADR-046 (typed server modules)
- Mirrored at: `reports/architecture/ADR-048-api-key-issuance-and-create-principal-plumbing.md` (this repo's convention for durable, code-cited numbered decisions — see ADR-030/034/etc.)
