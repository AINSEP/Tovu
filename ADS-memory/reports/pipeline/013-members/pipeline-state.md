...
| provider_output_root | ADS-memory/specs/013-members |
| spec_path | ADS-memory/specs/013-members |
| spec_entrypoint_path | ADS-memory/specs/013-members/feature.spec.md |
| spec_readiness_artifact | ADS-memory/specs/013-members/spec-dod.md |
...
- Ran `validate_spec_package.py ADS-memory/specs/013-members --phase preflight` → PASS
