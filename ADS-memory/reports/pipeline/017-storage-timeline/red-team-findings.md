...
- Location: `SPEC-017-feature.spec.md` Scope (Out of scope, REQ-28–REQ-30 bullet) and Dependencies table (`ADS-memory/specs/003-site-install-dir/` row)
