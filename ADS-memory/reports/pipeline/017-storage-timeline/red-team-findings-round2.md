...
| RT-005 | ADVISORY | **RESOLVED** | The Dependencies table's `ADS-memory/specs/003-site-install-dir/` row now carries "**Owner:** Software Architect for SPEC-017... **Resolve by:** before Programmer work begins on REQ-28–REQ-30," matching the rigor of every Open Question. |
