...
| provider_output_root | ADS-memory/specs/008-seo |
| spec_path | ADS-memory/specs/008-seo |
| spec_entrypoint_path | ADS-memory/specs/008-seo/feature.spec.md |
| spec_readiness_artifact | ADS-memory/specs/008-seo/spec-dod.md |
...
| pipeline_adr | `ADS-memory/reports/pipeline/008-seo/adr.md` (ADR-PIPE-008, PROPOSED 2026-07-13 — owes the human walkthrough approval ADR-PIPE-007 received, per that precedent) |
| implementation_outline | `ADS-memory/reports/pipeline/008-seo/implementation-outline.md` (PRODUCED 2026-07-13; Trigger result: Boundary Cross, Contract Change, Data And Persistence, Brownfield Dependency, Critical Cross-Boundary Invariant, Parallelization Ambiguity — System Wiring also applies per the outline's own matrix) |
