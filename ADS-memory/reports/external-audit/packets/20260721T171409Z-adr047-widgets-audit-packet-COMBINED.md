...
- **Authoring packet:** this file, plus its two appendices, all under
  `ADS-memory/.local-artifacts/external-audit/packets/20260721T171409Z-adr047-widgets-*`
...
| Path | Why it matters |
|---|---|
| `ADS-memory/reports/architecture/ADR-047-widgets-region-and-embed-placement.md` | The governing ADR, especially the 2026-07-21 Debate Fold-In section (6 amendments) — included in full below |
| `ADS-memory/specs/043-widgets/feature.spec.md` | The certified spec: 45 REQs, 30 ACs, 9 INVs, 8 ECs — included in full below |
| `ADS-memory/specs/043-widgets/spec-manifest.md` | Package index + disclosed provenance deviations — included in full below |
| `ADS-memory/reports/pipeline/043-widgets/implementation-outline.md` | Module/contract/wiring map produced from the spec — included in full below |
| `ADS-memory/reports/pipeline/043-widgets/implementation-report.md` | First-person account of baseline verification + all 4 gap-fix decisions and their eventual fixes — included in full below, **read in full** |
...
- `ADS-memory/reports/architecture/ADR-INDEX.md` — currently has an uncommitted local
...
1. **`src/widgets/embed-service.ts` does not exist anywhere in the delivered code.** The
   ...
   never thrown anywhere in the delivered code (confirmed: `ADS-memory/.../appendix-source.txt`
...
====================================================================
===== 1. ADR-047-widgets-region-and-embed-placement.md (full) =====
====================================================================
...
====================================================================
===== 2. SPEC-043 feature.spec.md (full) =====
====================================================================
...
| spec_root | ADS-memory/specs/043-widgets |
...
| `ui.spec.md` | OMITTED | `—` | A real admin UI surface is implied (widget library, region manager, placement picker, reuse/duplicate dialog) but not specified screen-by-screen here — deferred to the implementation outline, which will name concrete admin routes/components without needing a separate wireframe-level contract file for v1. |
...
| Stage | Must Read |
|---|---|
| `architect` (implementation outline) | `feature.spec.md` (this package's sole contract file), `ADR-047-widgets-region-and-embed-placement.md` (especially the Debate Fold-In section), `reports/swarm-consensus/runs/20260721-widgets-adr047-consensus-report.md`, `reports/swarm-consensus/offloads/20260721-widgets-adr047/` (all four peers' Round 2 artifacts — schema sketches, resolver interfaces, diff-shaped ADR language, spec-level acceptance criteria are directly reusable), `src/navigation/{types,ports,resolver,reconcile}.ts`, `src/forms/{submit-service,rate-limit-profile,notify-subscriber,manifest}.ts`, `src/infra/db/schema.ts` |
| `tdd` | `feature.spec.md` in full (Requirements/Acceptance Criteria/Invariants/Edge Cases), the implementation outline once produced, the same source touchpoints listed above |
| `programmer` | `feature.spec.md`, the implementation outline, certified tests, `ADR-047-widgets-region-and-embed-placement.md`, the same source touchpoints listed above |
...
====================================================================
===== 4. implementation-outline.md (full) =====
====================================================================
...
====================================================================
===== 5. implementation-report.md (full) =====
====================================================================
...
====================================================================
===== 6. APPENDIX A — full widgets + entry-refs source & tests =====
====================================================================
...
====================================================================
===== 7. APPENDIX B — shared-module diffs, schema, permissions, log =====
====================================================================
...
===== git status --short (full repo) =====
 M ADS-memory/reports/architecture/ADR-INDEX.md
