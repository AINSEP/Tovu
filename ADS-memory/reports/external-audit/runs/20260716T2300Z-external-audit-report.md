...
- **Save this report?** Currently drafted to `.local-artifacts/` (scratch, not retained). Reply "save report" to move it to `ADS-memory/reports/external-audit/runs/` as retained project evidence, or "local only" to leave it where it is.
