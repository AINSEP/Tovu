...
**Audit Packet:** `ADS-memory/.local-artifacts/external-audit/packets/20260717T035731Z-audit-packet.md` (+ appendices A–D + `-COMBINED.md` self-contained dispatch copy)
