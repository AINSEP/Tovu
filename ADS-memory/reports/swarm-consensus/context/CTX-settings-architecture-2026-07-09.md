...
| Path | Why it matters |
|---|---|
| `ADS-memory/reports/architecture/ADR-INDEX.md` | Map of all accepted decisions; read first |
...
>
> **Before designing, you MUST read** (they exist in this repo): `ADS-memory/reports/architecture/ADR-INDEX.md` and ADR-006, ADR-007, ADR-020, ADR-021, ADR-022, ADR-023, ADR-024, ADR-025, ADR-026 in `ADS-memory/reports/architecture/`, plus skim `src/features/presentation/`. Design **within** these accepted decisions; if you must diverge from one, name it and justify. Confirm in your first line which ADRs you read.
>
