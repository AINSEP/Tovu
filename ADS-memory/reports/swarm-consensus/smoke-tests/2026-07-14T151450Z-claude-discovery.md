...
- Generated at: `2026-07-14T15:14:50.563626+00:00`
...
|---|---|---|---|---|
| `claude` | `claude-sonnet-4-6` | `claude-sonnet-4-6` | `requested_model` | `discovery requirement=json` |
