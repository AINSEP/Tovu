...
- Generated at: `2026-07-14T15:17:49.770230+00:00`
...
|---|---|---|---|---|
| `claude` | `claude-sonnet-5` | `claude-sonnet-5` | `requested_model` | `discovery requirement=json` |
