...
`ADS-memory/reports/section-designs/20260710-comments-design.md`. Typed interfaces:
...
SPEC-032 (2026-07-16) made that engine real. Full record: `ADS-memory/specs/033-comments-v1-backend/feature.spec.md`.
