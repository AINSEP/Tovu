...
function snapshotFixture(overrides: Partial<AdminDeploymentOverview> = {}): AdminDeploymentOverview {
  return {
    ...
    // Added 2026-08-15 alongside the Static Site tab's real CLI-detection wiring — this hook's own
    // test never reads it, but `AdminDeploymentOverview` is now a required field, so a fixture with
    // none would fail to compile rather than fail a test.
    deployClis: [
