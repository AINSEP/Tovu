 ...
 * "Saved to the server…" / "Stored on the server…" status lines and the Local CLI scope label.
 *
 ...
 *
 * All five keys also live in `features/ai-assistant/ai-assistant-i18n.ts` for AI Assistant's mount of
