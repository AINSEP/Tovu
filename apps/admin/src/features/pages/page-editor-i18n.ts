...
const pageEditorMarkupTranslations: Record<string, Record<string, string>> = {
  es: { "Changed outside the editor, probably by the assistant. Loading the latest version discards your unsaved edits.": "Se cambió fuera del editor, probablemente el asistente. Cargar la última versión descarta tus ediciones sin guardar.", "Ask the assistant to build this page, or edit the HTML directly.": "Pide al asistente que cree esta página o edita el HTML directamente.", "Load latest": "Cargar la última versión", "Keep my edits": "Conservar mis ediciones", "Preview width": "Ancho de vista previa", "Page title": "Título de la página", Untitled: "Sin título", "Editor view": "Vista del editor", "Page HTML": "HTML de la página", "This page has no HTML yet. Ask the assistant to build it, or write some here.": "Esta página aún no tiene HTML. Pide al asistente que lo cree o escribe algo aquí.", "Loading the theme's styles…": "Cargando los estilos del tema…", "Page preview": "Vista previa de la página", "Loading pages…": "Cargando páginas…" , "Widget": "Widget", "Media": "Multimedia", "Post": "Entrada", "Collection": "Colección", "Partial": "Parcial", "Menu": "Menú", "Post previews": "Vistas previas de entradas", "no id set": "sin id establecido", "Latest posts": "Últimas entradas", "No template — HTML only": "Sin plantilla: solo HTML", "Serves only this page's HTML. No theme styles, scripts, header or footer.": "Solo entrega el HTML de esta página. Sin estilos, scripts, encabezado ni pie del tema.", "Theme default": "Predeterminado del tema" },
  de: { "Changed outside the editor, probably by the assistant. Loading the latest version discards your unsaved edits.": "Außerhalb des Editors geändert, wahrscheinlich vom Assistenten. Das Laden der neuesten Version verwirft deine ungespeicherten Änderungen.", "Ask the assistant to build this page, or edit the HTML directly.": "Bitte den Assistenten, diese Seite zu erstellen, oder bearbeite das HTML direkt.", "Load latest": "Neueste Version laden", "Keep my edits": "Meine Änderungen behalten", "Preview width": "Vorschaubreite", "Page title": "Seitentitel", Untitled: "Ohne Titel", "Editor view": "Editoransicht", "Page HTML": "Seiten-HTML", "This page has no HTML yet. Ask the assistant to build it, or write some here.": "Diese Seite hat noch kein HTML. Bitte den Assistenten, es zu erstellen, oder schreibe hier etwas.", "Loading the theme's styles…": "Design-Stile werden geladen…", "Page preview": "Seitenvorschau", "Loading pages…": "Seiten werden geladen…" , "Widget": "Widget", "Media": "Medien", "Post": "Beitrag", "Collection": "Sammlung", "Partial": "Partial", "Menu": "Menü", "Post previews": "Beitragsvorschauen", "no id set": "keine ID festgelegt", "Latest posts": "Neueste Beiträge", "No template — HTML only": "Kein Template — nur HTML", "Serves only this page's HTML. No theme styles, scripts, header or footer.": "Liefert nur das HTML dieser Seite. Keine Design-Stile, Skripte, Kopf- oder Fußzeile.", "Theme default": "Theme-Standard" },
  it: { "Changed outside the editor, probably by the assistant. Loading the latest version discards your unsaved edits.": "Modificata fuori dall'editor, probabilmente dall'assistente. Caricare l'ultima versione scarta le modifiche non salvate.", "Ask the assistant to build this page, or edit the HTML directly.": "Chiedi all'assistente di creare questa pagina oppure modifica direttamente l'HTML.", "Load latest": "Carica l'ultima versione", "Keep my edits": "Mantieni le mie modifiche", "Preview width": "Larghezza dell'anteprima", "Page title": "Titolo della pagina", Untitled: "Senza titolo", "Editor view": "Vista dell'editor", "Page HTML": "HTML della pagina", "This page has no HTML yet. Ask the assistant to build it, or write some here.": "Questa pagina non ha ancora HTML. Chiedi all'assistente di crearlo oppure scrivine qui.", "Loading the theme's styles…": "Caricamento degli stili del tema…", "Page preview": "Anteprima della pagina", "Loading pages…": "Caricamento pagine…" , "Widget": "Widget", "Media": "Media", "Post": "Articolo", "Collection": "Raccolta", "Partial": "Parziale", "Menu": "Menu", "Post previews": "Anteprime degli articoli", "no id set": "nessun id impostato", "Latest posts": "Ultimi articoli", "No template — HTML only": "Nessun modello — solo HTML", "Serves only this page's HTML. No theme styles, scripts, header or footer.": "Fornisce solo l'HTML di questa pagina. Nessuno stile, script, intestazione o piè di pagina del tema.", "Theme default": "Predefinito del tema" },
  "zh-CN": { "Changed outside the editor, probably by the assistant. Loading the latest version discards your unsaved edits.": "已在编辑器之外更改，可能是助手所为。加载最新版本会丢弃你未保存的编辑。", "Ask the assistant to build this page, or edit the HTML directly.": "让助手创建此页面，或直接编辑 HTML。", "Load latest": "加载最新版本", "Keep my edits": "保留我的编辑", "Preview width": "预览宽度", "Page title": "页面标题", Untitled: "未命名", "Editor view": "编辑器视图", "Page HTML": "页面 HTML", "This page has no HTML yet. Ask the assistant to build it, or write some here.": "此页面尚无 HTML。请让助手创建它，或在此处编写一些内容。", "Loading the theme's styles…": "正在加载主题样式…", "Page preview": "页面预览", "Loading pages…": "正在加载页面…" , "Widget": "小组件", "Media": "媒体", "Post": "文章", "Collection": "合集", "Partial": "局部模板", "Menu": "菜单", "Post previews": "文章预览", "no id set": "未设置 id", "Latest posts": "最新文章", "No template — HTML only": "无模板 — 仅 HTML", "Serves only this page's HTML. No theme styles, scripts, header or footer.": "仅提供此页面自身的 HTML。没有主题样式、脚本、页头或页脚。", "Theme default": "主题默认" },
  "zh-TW": { "Changed outside the editor, probably by the assistant. Loading the latest version discards your unsaved edits.": "已在編輯器之外變更，可能是助理所為。載入最新版本會捨棄你未儲存的編輯。", "Ask the assistant to build this page, or edit the HTML directly.": "請讓助理建立此頁面，或直接編輯 HTML。", "Load latest": "載入最新版本", "Keep my edits": "保留我的編輯", "Preview width": "預覽寬度", "Page title": "頁面標題", Untitled: "未命名", "Editor view": "編輯器檢視", "Page HTML": "頁面 HTML", "This page has no HTML yet. Ask the assistant to build it, or write some here.": "此頁面尚無 HTML。請讓助理建立它，或在此處撰寫一些內容。", "Loading the theme's styles…": "正在載入主題樣式…", "Page preview": "頁面預覽", "Loading pages…": "正在載入頁面…" , "Widget": "小工具", "Media": "媒體", "Post": "文章", "Collection": "合輯", "Partial": "局部模板", "Menu": "選單", "Post previews": "文章預覽", "no id set": "未設定 id", "Latest posts": "最新文章", "No template — HTML only": "無範本 — 僅 HTML", "Serves only this page's HTML. No theme styles, scripts, header or footer.": "僅提供此頁面自身的 HTML。沒有佈景主題樣式、指令碼、頁首或頁尾。", "Theme default": "佈景主題預設" },
  ar: { "Changed outside the editor, probably by the assistant. Loading the latest version discards your unsaved edits.": "تم التغيير خارج المحرر، على الأرجح بواسطة المساعد. تحميل أحدث إصدار يتجاهل تعديلاتك غير المحفوظة.", "Ask the assistant to build this page, or edit the HTML directly.": "اطلب من المساعد إنشاء هذه الصفحة، أو حرّر HTML مباشرةً.", "Load latest": "تحميل الأحدث", "Keep my edits": "الاحتفاظ بتعديلاتي", "Preview width": "عرض المعاينة", "Page title": "عنوان الصفحة", Untitled: "بلا عنوان", "Editor view": "عرض المحرر", "Page HTML": "HTML الصفحة", "This page has no HTML yet. Ask the assistant to build it, or write some here.": "لا تحتوي هذه الصفحة على HTML بعد. اطلب من المساعد إنشاؤه، أو اكتب بعضه هنا.", "Loading the theme's styles…": "جارٍ تحميل أنماط القالب…", "Page preview": "معاينة الصفحة", "Loading pages…": "جارٍ تحميل الصفحات…" , "Widget": "أداة", "Media": "وسائط", "Post": "منشور", "Collection": "مجموعة", "Partial": "جزئي", "Menu": "قائمة", "Post previews": "معاينات المنشورات", "no id set": "لم يتم تعيين معرف", "Latest posts": "أحدث المنشورات", "No template — HTML only": "بدون قالب — HTML فقط", "Serves only this page's HTML. No theme styles, scripts, header or footer.": "يعرض فقط HTML الخاص بهذه الصفحة. بدون أنماط أو نصوص برمجية أو رأس أو تذييل من القالب.", "Theme default": "الافتراضي للقالب" },
  fa: { "Changed outside the editor, probably by the assistant. Loading the latest version discards your unsaved edits.": "بیرون از ویرایشگر تغییر کرده است، احتمالاً توسط دستیار. بارگذاری آخرین نسخه، ویرایش‌های ذخیره‌نشدهٔ شما را دور می‌ریزد.", "Ask the assistant to build this page, or edit the HTML directly.": "از دستیار بخواهید این صفحه را بسازد، یا HTML را مستقیماً ویرایش کنید.", "Load latest": "بارگذاری آخرین نسخه", "Keep my edits": "ویرایش‌های من را نگه دار", "Preview width": "عرض پیش‌نمایش", "Page title": "عنوان صفحه", Untitled: "بدون عنوان", "Editor view": "نمای ویرایشگر", "Page HTML": "HTML صفحه", "This page has no HTML yet. Ask the assistant to build it, or write some here.": "این صفحه هنوز HTML ندارد. از دستیار بخواهید آن را بسازد، یا چیزی اینجا بنویسید.", "Loading the theme's styles…": "در حال بارگذاری سبک‌های پوسته…", "Page preview": "پیش‌نمایش صفحه", "Loading pages…": "در حال بارگذاری صفحه‌ها…" , "Widget": "ابزارک", "Media": "رسانه", "Post": "نوشته", "Collection": "مجموعه", "Partial": "جزئی", "Menu": "منو", "Post previews": "پیش‌نمایش نوشته‌ها", "no id set": "شناسه‌ای تنظیم نشده", "Latest posts": "آخرین نوشته‌ها", "No template — HTML only": "بدون قالب — فقط HTML", "Serves only this page's HTML. No theme styles, scripts, header or footer.": "فقط HTML خود این صفحه را ارائه می‌دهد. بدون سبک‌ها، اسکریپت‌ها، سربرگ یا پابرگ پوسته.", "Theme default": "پیش‌فرض پوسته" },
  ru: { "Changed outside the editor, probably by the assistant. Loading the latest version discards your unsaved edits.": "Изменено вне редактора, вероятно, ассистентом. Загрузка последней версии отменит ваши несохранённые правки.", "Ask the assistant to build this page, or edit the HTML directly.": "Попросите помощника создать эту страницу или отредактируйте HTML напрямую.", "Load latest": "Загрузить последнюю версию", "Keep my edits": "Сохранить мои изменения", "Preview width": "Ширина предпросмотра", "Page title": "Заголовок страницы", Untitled: "Без названия", "Editor view": "Вид редактора", "Page HTML": "HTML страницы", "This page has no HTML yet. Ask the assistant to build it, or write some here.": "У этой страницы пока нет HTML. Попросите помощника создать его или напишите что-нибудь здесь.", "Loading the theme's styles…": "Загрузка стилей темы…", "Page preview": "Предпросмотр страницы", "Loading pages…": "Загрузка страниц…" , "Widget": "Виджет", "Media": "Медиа", "Post": "Запись", "Collection": "Коллекция", "Partial": "Частичный шаблон", "Menu": "Меню", "Post previews": "Превью записей", "no id set": "id не задан", "Latest posts": "Последние записи", "No template — HTML only": "Без шаблона — только HTML", "Serves only this page's HTML. No theme styles, scripts, header or footer.": "Отдаёт только HTML этой страницы. Без стилей, скриптов, шапки и подвала темы.", "Theme default": "Тема по умолчанию" },
  ja: { "Changed outside the editor, probably by the assistant. Loading the latest version discards your unsaved edits.": "エディターの外で変更されました（おそらくアシスタントによるもの）。最新バージョンを読み込むと、保存していない編集は破棄されます。", "Ask the assistant to build this page, or edit the HTML directly.": "アシスタントにこのページを作成してもらうか、HTML を直接編集してください。", "Load latest": "最新を読み込む", "Keep my edits": "編集内容を保持", "Preview width": "プレビューの幅", "Page title": "ページタイトル", Untitled: "無題", "Editor view": "エディター表示", "Page HTML": "ページ HTML", "This page has no HTML yet. Ask the assistant to build it, or write some here.": "このページにはまだ HTML がありません。アシスタントに作成を依頼するか、ここに入力してください。", "Loading the theme's styles…": "テーマのスタイルを読み込み中…", "Page preview": "ページプレビュー", "Loading pages…": "ページを読み込み中…" , "Widget": "ウィジェット", "Media": "メディア", "Post": "投稿", "Collection": "コレクション", "Partial": "パーシャル", "Menu": "メニュー", "Post previews": "投稿プレビュー", "no id set": "idが設定されていません", "Latest posts": "最新の投稿", "No template — HTML only": "テンプレートなし — HTMLのみ", "Serves only this page's HTML. No theme styles, scripts, header or footer.": "このページ自身のHTMLのみを表示します。テーマのスタイル、スクリプト、ヘッダー、フッターはありません。", "Theme default": "テーマの既定" },
  id: { "Changed outside the editor, probably by the assistant. Loading the latest version discards your unsaved edits.": "Diubah di luar editor, kemungkinan oleh asisten. Memuat versi terbaru akan membuang suntingan Anda yang belum disimpan.", "Ask the assistant to build this page, or edit the HTML directly.": "Minta asisten membuat halaman ini, atau edit HTML secara langsung.", "Load latest": "Muat versi terbaru", "Keep my edits": "Pertahankan editan saya", "Preview width": "Lebar pratinjau", "Page title": "Judul halaman", Untitled: "Tanpa judul", "Editor view": "Tampilan editor", "Page HTML": "HTML halaman", "This page has no HTML yet. Ask the assistant to build it, or write some here.": "Halaman ini belum memiliki HTML. Minta asisten membuatnya, atau tulis sesuatu di sini.", "Loading the theme's styles…": "Memuat gaya tema…", "Page preview": "Pratinjau halaman", "Loading pages…": "Memuat halaman…" , "Widget": "Widget", "Media": "Media", "Post": "Postingan", "Collection": "Koleksi", "Partial": "Parsial", "Menu": "Menu", "Post previews": "Pratinjau postingan", "no id set": "id tidak diatur", "Latest posts": "Postingan terbaru", "No template — HTML only": "Tanpa templat — hanya HTML", "Serves only this page's HTML. No theme styles, scripts, header or footer.": "Hanya menyajikan HTML halaman ini sendiri. Tanpa gaya, skrip, header, atau footer tema.", "Theme default": "Bawaan tema" },
  "pt-BR": { "Changed outside the editor, probably by the assistant. Loading the latest version discards your unsaved edits.": "Alterada fora do editor, provavelmente pelo assistente. Carregar a versão mais recente descarta suas edições não salvas.", "Ask the assistant to build this page, or edit the HTML directly.": "Peça ao assistente para criar esta página ou edite o HTML diretamente.", "Load latest": "Carregar a versão mais recente", "Keep my edits": "Manter minhas edições", "Preview width": "Largura da visualização", "Page title": "Título da página", Untitled: "Sem título", "Editor view": "Visualização do editor", "Page HTML": "HTML da página", "This page has no HTML yet. Ask the assistant to build it, or write some here.": "Esta página ainda não tem HTML. Peça ao assistente para criá-lo ou escreva algo aqui.", "Loading the theme's styles…": "Carregando os estilos do tema…", "Page preview": "Visualização da página", "Loading pages…": "Carregando páginas…" , "Widget": "Widget", "Media": "Mídia", "Post": "Postagem", "Collection": "Coleção", "Partial": "Parcial", "Menu": "Menu", "Post previews": "Prévias de postagens", "no id set": "nenhum id definido", "Latest posts": "Últimas postagens", "No template — HTML only": "Sem modelo — somente HTML", "Serves only this page's HTML. No theme styles, scripts, header or footer.": "Entrega apenas o HTML desta página. Sem estilos, scripts, cabeçalho ou rodapé do tema.", "Theme default": "Padrão do tema" },
  ko: { "Changed outside the editor, probably by the assistant. Loading the latest version discards your unsaved edits.": "편집기 밖에서 변경되었습니다. 아마 어시스턴트가 변경했을 것입니다. 최신 버전을 불러오면 저장하지 않은 편집 내용이 삭제됩니다.", "Ask the assistant to build this page, or edit the HTML directly.": "도우미에게 이 페이지를 만들도록 요청하거나 HTML을 직접 편집하세요.", "Load latest": "최신 버전 불러오기", "Keep my edits": "내 편집 내용 유지", "Preview width": "미리 보기 너비", "Page title": "페이지 제목", Untitled: "제목 없음", "Editor view": "편집기 보기", "Page HTML": "페이지 HTML", "This page has no HTML yet. Ask the assistant to build it, or write some here.": "이 페이지에는 아직 HTML이 없습니다. 도우미에게 만들도록 요청하거나 여기에서 직접 작성하세요.", "Loading the theme's styles…": "테마 스타일을 불러오는 중…", "Page preview": "페이지 미리 보기", "Loading pages…": "페이지를 불러오는 중…" , "Widget": "위젯", "Media": "미디어", "Post": "게시물", "Collection": "컬렉션", "Partial": "부분 템플릿", "Menu": "메뉴", "Post previews": "게시물 미리 보기", "no id set": "id가 설정되지 않음", "Latest posts": "최신 게시물", "No template — HTML only": "템플릿 없음 — HTML만", "Serves only this page's HTML. No theme styles, scripts, header or footer.": "이 페이지 자체의 HTML만 제공합니다. 테마 스타일, 스크립트, 헤더, 푸터가 없습니다.", "Theme default": "테마 기본값" },
  pl: { "Changed outside the editor, probably by the assistant. Loading the latest version discards your unsaved edits.": "Zmieniono poza edytorem, prawdopodobnie przez asystenta. Wczytanie najnowszej wersji odrzuci niezapisane zmiany.", "Ask the assistant to build this page, or edit the HTML directly.": "Poproś asystenta o utworzenie tej strony albo edytuj HTML bezpośrednio.", "Load latest": "Wczytaj najnowszą wersję", "Keep my edits": "Zachowaj moje zmiany", "Preview width": "Szerokość podglądu", "Page title": "Tytuł strony", Untitled: "Bez tytułu", "Editor view": "Widok edytora", "Page HTML": "HTML strony", "This page has no HTML yet. Ask the assistant to build it, or write some here.": "Ta strona nie ma jeszcze HTML. Poproś asystenta o jego utworzenie albo napisz coś tutaj.", "Loading the theme's styles…": "Wczytywanie stylów motywu…", "Page preview": "Podgląd strony", "Loading pages…": "Wczytywanie stron…" , "Widget": "Widżet", "Media": "Multimedia", "Post": "Wpis", "Collection": "Kolekcja", "Partial": "Częściowy szablon", "Menu": "Menu", "Post previews": "Podglądy wpisów", "no id set": "nie ustawiono id", "Latest posts": "Najnowsze wpisy", "No template — HTML only": "Bez szablonu — tylko HTML", "Serves only this page's HTML. No theme styles, scripts, header or footer.": "Udostępnia tylko własny HTML tej strony. Bez stylów, skryptów, nagłówka ani stopki motywu.", "Theme default": "Domyślny motywu" },
  hu: { "Changed outside the editor, probably by the assistant. Loading the latest version discards your unsaved edits.": "A szerkesztőn kívül módosult, valószínűleg az asszisztens által. A legújabb verzió betöltése elveti a nem mentett módosításaidat.", "Ask the assistant to build this page, or edit the HTML directly.": "Kérje meg az asszisztenst az oldal elkészítésére, vagy szerkessze közvetlenül a HTML-t.", "Load latest": "Legújabb verzió betöltése", "Keep my edits": "Szerkesztéseim megtartása", "Preview width": "Előnézet szélessége", "Page title": "Oldal címe", Untitled: "Névtelen", "Editor view": "Szerkesztőnézet", "Page HTML": "Oldal HTML-je", "This page has no HTML yet. Ask the assistant to build it, or write some here.": "Ennek az oldalnak még nincs HTML-je. Kérje meg az asszisztenst az elkészítésére, vagy írjon ide valamit.", "Loading the theme's styles…": "Téma stílusainak betöltése…", "Page preview": "Oldal előnézete", "Loading pages…": "Oldalak betöltése…" , "Widget": "Widget", "Media": "Média", "Post": "Bejegyzés", "Collection": "Gyűjtemény", "Partial": "Részleges sablon", "Menu": "Menü", "Post previews": "Bejegyzés-előnézetek", "no id set": "nincs beállítva id", "Latest posts": "Legújabb bejegyzések", "No template — HTML only": "Nincs sablon — csak HTML", "Serves only this page's HTML. No theme styles, scripts, header or footer.": "Csak az oldal saját HTML-jét szolgálja ki. Nincs téma stílus, szkript, fejléc vagy lábléc.", "Theme default": "Téma alapértelmezés" },
  fr: { "Changed outside the editor, probably by the assistant. Loading the latest version discards your unsaved edits.": "Modifiée en dehors de l'éditeur, probablement par l'assistant. Charger la dernière version supprime vos modifications non enregistrées.", "Ask the assistant to build this page, or edit the HTML directly.": "Demandez à l'assistant de créer cette page, ou modifiez directement le HTML.", "Load latest": "Charger la dernière version", "Keep my edits": "Conserver mes modifications", "Preview width": "Largeur de l'aperçu", "Page title": "Titre de la page", Untitled: "Sans titre", "Editor view": "Vue de l'éditeur", "Page HTML": "HTML de la page", "This page has no HTML yet. Ask the assistant to build it, or write some here.": "Cette page n'a pas encore de HTML. Demandez à l'assistant de le créer ou écrivez-en ici.", "Loading the theme's styles…": "Chargement des styles du thème…", "Page preview": "Aperçu de la page", "Loading pages…": "Chargement des pages…" , "Widget": "Widget", "Media": "Média", "Post": "Article", "Collection": "Collection", "Partial": "Partiel", "Menu": "Menu", "Post previews": "Aperçus d'articles", "no id set": "aucun id défini", "Latest posts": "Derniers articles", "No template — HTML only": "Aucun modèle — HTML seul", "Serves only this page's HTML. No theme styles, scripts, header or footer.": "Ne diffuse que le HTML propre à cette page. Aucun style, script, en-tête ou pied de page du thème.", "Theme default": "Thème par défaut" },
  uk: { "Changed outside the editor, probably by the assistant. Loading the latest version discards your unsaved edits.": "Змінено поза редактором, імовірно, асистентом. Завантаження останньої версії скасує ваші незбережені зміни.", "Ask the assistant to build this page, or edit the HTML directly.": "Попросіть помічника створити цю сторінку або відредагуйте HTML безпосередньо.", "Load latest": "Завантажити останню версію", "Keep my edits": "Зберегти мої зміни", "Preview width": "Ширина попереднього перегляду", "Page title": "Заголовок сторінки", Untitled: "Без назви", "Editor view": "Вигляд редактора", "Page HTML": "HTML сторінки", "This page has no HTML yet. Ask the assistant to build it, or write some here.": "Ця сторінка ще не має HTML. Попросіть помічника створити його або напишіть щось тут.", "Loading the theme's styles…": "Завантаження стилів теми…", "Page preview": "Попередній перегляд сторінки", "Loading pages…": "Завантаження сторінок…" , "Widget": "Віджет", "Media": "Медіа", "Post": "Запис", "Collection": "Колекція", "Partial": "Частковий шаблон", "Menu": "Меню", "Post previews": "Прев'ю записів", "no id set": "id не задано", "Latest posts": "Останні записи", "No template — HTML only": "Без шаблону — лише HTML", "Serves only this page's HTML. No theme styles, scripts, header or footer.": "Показує лише власний HTML цієї сторінки. Без стилів, скриптів, шапки чи підвалу теми.", "Theme default": "Тема за замовчуванням" },
  tr: { "Changed outside the editor, probably by the assistant. Loading the latest version discards your unsaved edits.": "Düzenleyicinin dışında, büyük olasılıkla asistan tarafından değiştirildi. En son sürümü yüklemek kaydedilmemiş düzenlemelerinizi siler.", "Ask the assistant to build this page, or edit the HTML directly.": "Asistandan bu sayfayı oluşturmasını isteyin veya HTML'yi doğrudan düzenleyin.", "Load latest": "En son sürümü yükle", "Keep my edits": "Düzenlemelerimi koru", "Preview width": "Önizleme genişliği", "Page title": "Sayfa başlığı", Untitled: "Başlıksız", "Editor view": "Düzenleyici görünümü", "Page HTML": "Sayfa HTML'si", "This page has no HTML yet. Ask the assistant to build it, or write some here.": "Bu sayfanın henüz HTML'si yok. Asistandan oluşturmasını isteyin veya buraya bir şey yazın.", "Loading the theme's styles…": "Tema stilleri yükleniyor…", "Page preview": "Sayfa önizlemesi", "Loading pages…": "Sayfalar yükleniyor…" , "Widget": "Widget", "Media": "Medya", "Post": "Gönderi", "Collection": "Koleksiyon", "Partial": "Kısmi şablon", "Menu": "Menü", "Post previews": "Gönderi önizlemeleri", "no id set": "id ayarlanmadı", "Latest posts": "En son gönderiler", "No template — HTML only": "Şablon yok — yalnızca HTML", "Serves only this page's HTML. No theme styles, scripts, header or footer.": "Yalnızca bu sayfanın kendi HTML'sini sunar. Tema stilleri, betikleri, üstbilgi veya altbilgi yoktur.", "Theme default": "Tema varsayılanı" },
  th: { "Changed outside the editor, probably by the assistant. Loading the latest version discards your unsaved edits.": "มีการเปลี่ยนแปลงนอกตัวแก้ไข อาจเป็นผู้ช่วย การโหลดเวอร์ชันล่าสุดจะทิ้งการแก้ไขที่ยังไม่ได้บันทึกของคุณ", "Ask the assistant to build this page, or edit the HTML directly.": "ขอให้ผู้ช่วยสร้างหน้านี้ หรือแก้ไข HTML โดยตรง", "Load latest": "โหลดเวอร์ชันล่าสุด", "Keep my edits": "เก็บการแก้ไขของฉัน", "Preview width": "ความกว้างตัวอย่าง", "Page title": "ชื่อหน้า", Untitled: "ไม่มีชื่อ", "Editor view": "มุมมองตัวแก้ไข", "Page HTML": "HTML ของหน้า", "This page has no HTML yet. Ask the assistant to build it, or write some here.": "หน้านี้ยังไม่มี HTML ขอให้ผู้ช่วยสร้าง หรือเขียนบางอย่างที่นี่", "Loading the theme's styles…": "กำลังโหลดสไตล์ของธีม…", "Page preview": "ตัวอย่างหน้า", "Loading pages…": "กำลังโหลดหน้า…" , "Widget": "วิดเจ็ต", "Media": "สื่อ", "Post": "โพสต์", "Collection": "คอลเลกชัน", "Partial": "เทมเพลตบางส่วน", "Menu": "เมนู", "Post previews": "ตัวอย่างโพสต์", "no id set": "ไม่ได้ตั้งค่า id", "Latest posts": "โพสต์ล่าสุด", "No template — HTML only": "ไม่มีเทมเพลต — HTML เท่านั้น", "Serves only this page's HTML. No theme styles, scripts, header or footer.": "แสดงเฉพาะ HTML ของหน้านี้เท่านั้น ไม่มีสไตล์ สคริปต์ ส่วนหัว หรือส่วนท้ายของธีม", "Theme default": "ค่าเริ่มต้นของธีม" },
  hi: { "Changed outside the editor, probably by the assistant. Loading the latest version discards your unsaved edits.": "एडिटर के बाहर बदला गया, शायद असिस्टेंट ने। नवीनतम संस्करण लोड करने से आपके बिना सहेजे संपादन हट जाएँगे।", "Ask the assistant to build this page, or edit the HTML directly.": "सहायक से यह पेज बनाने को कहें, या HTML को सीधे संपादित करें।", "Load latest": "नवीनतम लोड करें", "Keep my edits": "मेरे संपादन रखें", "Preview width": "पूर्वावलोकन की चौड़ाई", "Page title": "पेज शीर्षक", Untitled: "शीर्षकहीन", "Editor view": "संपादक दृश्य", "Page HTML": "पेज HTML", "This page has no HTML yet. Ask the assistant to build it, or write some here.": "इस पेज में अभी HTML नहीं है। सहायक से इसे बनाने को कहें, या यहाँ कुछ लिखें।", "Loading the theme's styles…": "थीम की शैलियाँ लोड हो रही हैं…", "Page preview": "पेज पूर्वावलोकन", "Loading pages…": "पेज लोड हो रहे हैं…" , "Widget": "विजेट", "Media": "मीडिया", "Post": "पोस्ट", "Collection": "संग्रह", "Partial": "आंशिक टेम्पलेट", "Menu": "मेन्यू", "Post previews": "पोस्ट पूर्वावलोकन", "no id set": "कोई id सेट नहीं", "Latest posts": "नवीनतम पोस्ट", "No template — HTML only": "कोई टेम्पलेट नहीं — केवल HTML", "Serves only this page's HTML. No theme styles, scripts, header or footer.": "केवल इस पेज का अपना HTML दिखाता है। कोई थीम शैली, स्क्रिप्ट, हेडर या फुटर नहीं।", "Theme default": "थीम डिफ़ॉल्ट" },
  ur: { "Changed outside the editor, probably by the assistant. Loading the latest version discards your unsaved edits.": "ایڈیٹر کے باہر تبدیل کیا گیا، غالباً اسسٹنٹ نے۔ تازہ ترین ورژن لوڈ کرنے سے آپ کی غیر محفوظ ترامیم ضائع ہو جائیں گی۔", "Ask the assistant to build this page, or edit the HTML directly.": "اس صفحے کو بنانے کے لیے معاون سے کہیں، یا HTML کو براہِ راست ترمیم کریں۔", "Load latest": "تازہ ترین لوڈ کریں", "Keep my edits": "میری ترامیم رکھیں", "Preview width": "پیش نظارے کی چوڑائی", "Page title": "صفحے کا عنوان", Untitled: "بلا عنوان", "Editor view": "ایڈیٹر منظر", "Page HTML": "صفحے کا HTML", "This page has no HTML yet. Ask the assistant to build it, or write some here.": "اس صفحے میں ابھی HTML نہیں ہے۔ معاون سے اسے بنانے کو کہیں، یا یہاں کچھ لکھیں۔", "Loading the theme's styles…": "تھیم کے انداز لوڈ ہو رہے ہیں…", "Page preview": "صفحے کا پیش نظارہ", "Loading pages…": "صفحات لوڈ ہو رہے ہیں…" , "Widget": "ویجٹ", "Media": "میڈیا", "Post": "پوسٹ", "Collection": "مجموعہ", "Partial": "جزوی ٹیمپلیٹ", "Menu": "مینو", "Post previews": "پوسٹ پیش نظارے", "no id set": "کوئی id سیٹ نہیں", "Latest posts": "تازہ ترین پوسٹس", "No template — HTML only": "کوئی ٹیمپلیٹ نہیں — صرف HTML", "Serves only this page's HTML. No theme styles, scripts, header or footer.": "صرف اس صفحے کا اپنا HTML فراہم کرتا ہے۔ کوئی تھیم اسٹائل، اسکرپٹ، ہیڈر یا فوٹر نہیں۔", "Theme default": "تھیم ڈیفالٹ" },
  bn: { "Changed outside the editor, probably by the assistant. Loading the latest version discards your unsaved edits.": "এডিটরের বাইরে পরিবর্তন করা হয়েছে, সম্ভবত সহকারী করেছে। সর্বশেষ সংস্করণ লোড করলে আপনার অসংরক্ষিত সম্পাদনা বাতিল হবে।", "Ask the assistant to build this page, or edit the HTML directly.": "সহকারীকে এই পেজটি তৈরি করতে বলুন, বা সরাসরি HTML সম্পাদনা করুন।", "Load latest": "সর্বশেষ সংস্করণ লোড করুন", "Keep my edits": "আমার সম্পাদনা রাখুন", "Preview width": "প্রিভিউ প্রস্থ", "Page title": "পেজের শিরোনাম", Untitled: "শিরোনামহীন", "Editor view": "সম্পাদনা দৃশ্য", "Page HTML": "পেজ HTML", "This page has no HTML yet. Ask the assistant to build it, or write some here.": "এই পেজে এখনও HTML নেই। সহকারীকে এটি তৈরি করতে বলুন, বা এখানে কিছু লিখুন।", "Loading the theme's styles…": "থিমের শৈলী লোড হচ্ছে…", "Page preview": "পেজ প্রিভিউ", "Loading pages…": "পেজ লোড হচ্ছে…" , "Widget": "উইজেট", "Media": "মিডিয়া", "Post": "পোস্ট", "Collection": "সংগ্রহ", "Partial": "আংশিক টেমপ্লেট", "Menu": "মেনু", "Post previews": "পোস্ট প্রিভিউ", "no id set": "কোনো id সেট নেই", "Latest posts": "সাম্প্রতিক পোস্ট", "No template — HTML only": "কোনো টেমপ্লেট নেই — শুধু HTML", "Serves only this page's HTML. No theme styles, scripts, header or footer.": "শুধু এই পেজের নিজস্ব HTML পরিবেশন করে। কোনো থিম স্টাইল, স্ক্রিপ্ট, হেডার বা ফুটার নেই।", "Theme default": "থিমের ডিফল্ট" },
};

// "No template chosen" removed (bare-page ruling 2026-09-23, S6) — Pages no longer show that label at
// all (replaced by "No template — HTML only", a `pageEditorMarkupTranslations` key below, since Pages
// and Posts diverge in meaning for `""` now). Posts still show it unchanged, via `posts-i18n.ts`'s own
