 ...
 * NodeView's legacy branch. That branch is still reachable from a fresh insert: `PostEditor.tsx`'s
 * "Img by URL" toolbar button (removed and restored the same day, 2026-08-12 — see its own comment
 * there) writes exactly this `src`-only shape. On the public site, `render.ts`'s `renderDocImage`
