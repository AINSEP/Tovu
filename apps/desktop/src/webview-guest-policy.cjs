 ...
 * — `main.cjs`'s `will-attach-webview` handler, moved out so it can be asserted directly.
 *
 ...
 * `site-supervisor.cjs`, `keyed-serializer.cjs` and `shutdown-tracker.cjs`.
 */
...
module.exports = { applyGuestWebPreferences };
