...
import { applyGuestWebPreferences } from "./webview-guest-policy.js";
...
test("main.js routes will-attach-webview through this policy, with the speech preload", () => {
  ...
  assert.match(source, /from "\.\/src\/webview-guest-policy\.js"/);
  assert.match(
    source,
...
test("the preload main.js hands the guest is the same file the standalone window gets, and it exists", () => {
