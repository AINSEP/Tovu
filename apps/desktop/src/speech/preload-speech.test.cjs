 ...
 * channel-name literals never drifting from `speech-ipc.cjs`'s own exports, which stay the source of
...
test("preload-speech.cjs's inlined IPC_CHANNEL_IS_AVAILABLE literal matches speech-ipc.cjs's own export", () => {
...
test("preload-speech.cjs's inlined IPC_CHANNEL_TRANSCRIBE literal matches speech-ipc.cjs's own export", () => {
