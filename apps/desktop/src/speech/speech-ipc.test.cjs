/**
 * @file Direct tests for `speech-ipc.cjs`. No real Electron `ipcMain` — a tiny fake that records
...
const { registerSpeechIpc, IPC_CHANNEL_IS_AVAILABLE, IPC_CHANNEL_TRANSCRIBE } = require("./speech-ipc.cjs");
