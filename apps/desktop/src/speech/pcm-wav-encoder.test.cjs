/**
 * @file Direct tests for `pcm-wav-encoder.cjs` — pure buffer math, no Electron and no audio
 * hardware involved.
 */
const test = require("node:test");
const assert = require("node:assert/strict");

const { encodeMonoWav, float32ToInt16Pcm, buildWavHeader, WAV_HEADER_BYTES } = require("./pcm-wav-encoder.cjs");
