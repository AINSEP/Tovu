 ...
 * `window.tovuRunner` bridge. The tag is enabled by `webviewTag` in `src/main/main.ts`, which
 * also pins the guest's `webPreferences` from `will-attach-webview` — nothing the renderer
  ...
  namespace JSX {
    interface IntrinsicElements {
      webview: HTMLAttributes<HTMLElement> & {
        src?: string;
        /** Names the guest's session partition. Omitted today: every project shares the default. */
        partition?: string;
      };
    }
  }
