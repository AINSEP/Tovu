/**
 * Deliberately narrow renderer bridge for the FLEET window. This is a native ESM Electron preload:
 ...
 * channels `registerSpeechIpc` registers — see this file's header for why the fleet window needs
