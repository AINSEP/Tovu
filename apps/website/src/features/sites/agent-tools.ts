...
export const sitesAgentToolCatalog: readonly AgentToolDefinition[] = [
  {
    ...
    description: [
      ...
      "The user must approve the copy in a confirmation dialog first (it includes saved credentials); if they cancel, the result says duplicated: false and nothing is created.",
