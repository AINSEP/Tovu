...
| provider_output_root | ADS-project-knowledge/specs/010-forms |
| spec_path | ADS-project-knowledge/specs/010-forms |
| spec_entrypoint_path | ADS-project-knowledge/specs/010-forms/feature.spec.md |
| spec_readiness_artifact | ADS-project-knowledge/specs/010-forms/spec-dod.md |
...
- Runs independently of the other in-progress spec folders (`012-menus`, `013-members`,
  `014-analytics`, `015-integrations`) observed in `ADS-project-knowledge/specs/` during this
