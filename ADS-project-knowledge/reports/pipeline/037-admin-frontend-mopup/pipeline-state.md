...
- provider_output_root: ADS-project-knowledge/specs/037-admin-frontend-mopup/
- spec_entrypoint_path: ADS-project-knowledge/specs/037-admin-frontend-mopup/feature.spec.md
