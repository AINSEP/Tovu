...
| provider_output_root | ADS-project-knowledge/specs/015-integrations |
| spec_path | ADS-project-knowledge/specs/015-integrations |
| spec_entrypoint_path | ADS-project-knowledge/specs/015-integrations/feature.spec.md |
| spec_readiness_artifact | ADS-project-knowledge/specs/015-integrations/spec-dod.md |
...
| pipeline_adr | `ADS-project-knowledge/reports/pipeline/015-integrations/adr.md` (ADR-PIPE-015, PROPOSED 2026-07-13) — a remediation implementation ADR closing GAP-01..GAP-06 and GAP-12 against the already-ACCEPTED ADR-036; does not re-litigate ADR-036/038/040's own decisions |
...
| implementation_outline_path | `ADS-project-knowledge/reports/pipeline/015-integrations/implementation-outline.md` — Status: PRODUCED (triggers: Boundary Cross, Contract Change, System Wiring, Data And Persistence, Brownfield Dependency, Critical Cross-Boundary Invariant, Parallelization Ambiguity) |
...
- **Scope of this run:** Spec Agent dispatch only, as a **lightweight as-built backfill** — not
  ...
  `ADS-project-knowledge/specs/015-integrations/`. `orchestrator.spec.md` is OMITTED (see
...
- **Validator run and passed clean.** `python3 AI-Dev-Shop/framework/spec-providers/speckit/validators/validate_spec_package.py ADS-project-knowledge/specs/015-integrations --phase spec --update-hash`
