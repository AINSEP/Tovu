...
- Red-Team status and artifact: PASS (0 BLOCKING after confirm-pass), 1 ADVISORY (RT-004, rate-limit note) carried forward — `ADS-project-knowledge/reports/pipeline/007-settings-core-ledger/red-team-findings.md`
