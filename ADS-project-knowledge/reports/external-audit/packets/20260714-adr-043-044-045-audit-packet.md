...
- **Authoring packet:** `ADS-project-knowledge/reports/external-audit/packets/20260714-adr-043-044-045-audit-packet.md`
...
| Path | Why it matters |
|---|---|
| `ADS-project-knowledge/reports/architecture/ADR-043-collections.md` | Full text embedded below — Collections content-type registry design |
| `ADS-project-knowledge/reports/architecture/ADR-044-categories-and-tags.md` | Full text embedded below — shared taxonomy design |
| `ADS-project-knowledge/reports/architecture/ADR-045-backups-recovery-screen.md` | Full text embedded below — Recovery/Backups screen design |
