...
- decisions_file: `ADS-project-knowledge/reports/architecture/ADR-INDEX.md`
...
2. `ADS-project-knowledge/reports/architecture/ADR-INDEX.md` — ADR-001
...
- `ADS-project-knowledge/reports/architecture/ADR-002…011 + ADR-INDEX.md`.
