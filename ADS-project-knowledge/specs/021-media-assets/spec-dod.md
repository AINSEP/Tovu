...
| # | Item | Status | Notes |
|---|------|--------|-------|
| B-01 | spec_id assigned and unique | PASS | SPEC-021 — verified against `ADS-project-knowledge/reports/pipeline/` (001-015 exist) and the reserved-but-unused SPEC-016..020 range per dispatch instruction |
