...
- [x] spec_id assigned and unique (verified against existing `ADS-project-knowledge/reports/pipeline/` folders — 001…009 exist; 013 matches the fixed FEAT number in the dispatch directive)
